...
static const Command_Handler_Lookup_Type command_handler_lookup_table[] = { ABCC_API_OBJ_ATTRIBUTE_RESPONSE_LIST ABCC_APPLICATION_OBJ_SERIAL_NR_GET_CBFUNC, ABCC_APPLICATION_OBJ_PRODUCT_NAME_GET_CBFUNC, ABCC_APPLICATION_OBJ_VENDOR_NAME_GET_VALUE("My Company Name"),{ .bObject = 248, .bInstance = 0x01, .uCmdExt.bAttr = 1, .bCommand = ABP_CMD_GET_ATTR, .eServiceTag = SERVICE_UINT16, .uData.iUnsigned16 = (0xBEEF) },{ .bObject = 248, .bInstance = 0x01, .uCmdExt.bAttr = 2, .bCommand = ABP_CMD_GET_ATTR, .eServiceTag = SERVICE_UINT16, .uCbx.pnGetUint16Attr = ABCC_CbfEthernetIpObjDeviceType_Get },{ .bObject = 248, .bInstance = 0x01, .uCmdExt.bAttr = 3, .bCommand = ABP_CMD_GET_ATTR, .eServiceTag = SERVICE_UINT16, .uCbx.pnGetUint16Attr = ABCC_CbfEthernetIpObjProductCode_Get },{ .bObject = 248, .bInstance = 0x01, .uCmdExt.bAttr = 4, .bCommand = ABP_CMD_GET_ATTR, .eServiceTag = SERVICE_BUFFER, .uData.pacStringBuffer = ("\x44\x43"), .uAttrLength.iDataSize = (2 * 1) },{ .bObject = 246, .bInstance = 0x01, .uCmdExt.bAttr = 2, .bCommand = ABP_CMD_GET_ATTR, .eServiceTag = SERVICE_UINT16, .uData.iUnsigned16 = (0xDEAD) },{ .bObject = 246, .bInstance = 0x01, .uCmdExt.bAttr = 1, .bCommand = ABP_CMD_GET_ATTR, .eServiceTag = SERVICE_UINT16, .uCbx.pnGetUint16Attr = ABCC_CbfProfinetIoObjDeviceId_Get },{ .bObject = 246, .bInstance = 0x01, .uCmdExt.bAttr = 8, .bCommand = ABP_CMD_GET_ATTR, .eServiceTag = SERVICE_STR, .uAttrLength.iMaxDataSize = (20 * 1), .uCbx.pnGetStrAttr = ABCC_CbfProfinetIoObjOrderId_Get }, ABCC_APPLICATION_OBJ_FW_AVAILABLE_GET_CBFUNC, ABCC_APPLICATION_OBJ_FW_AVAILABLE_SET_CBFUNC, };
#else
