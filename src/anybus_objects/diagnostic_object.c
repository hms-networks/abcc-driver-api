...
**------------------------------------------------------------------------------
** Arguments:
**    iChannelNumber, iChannelProperties, iChannelErrorType - The combination  iExtChannelErrorTypelExtChannelAddValue  FIXME
**    of PROFINET diagnosis values to check.
** Returns:
...
static BOOL di_prt_ValidateChannelDiagArgs( UINT16 iChannelNumber, UINT16 iChannelProperties, UINT16 iChannelErrorType )
{
   ...
   {
      /*
      ** ChannelNumber == Submodule in only allowed if
