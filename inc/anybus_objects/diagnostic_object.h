...
**               unsupported.
**    bElement - Element associated with the diag. event. Set to '255' if
**               unknown or unsupported.
...
** handled by the command sequencer if that is used, otherwise one needs to
** call ABCC_SendCmdMsg() manually.
**
...
** - PROFINET International doc.no 7.142, "Diagnosis for PROFINET, Guideline for PROFINET"
**------------------------------------------------------------------------------
*/
